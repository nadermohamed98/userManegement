...
$numPagesQuery = "SELECT * FROM users WHERE deleted_at IS NULL AND role_id=1 $sqlFilter;";
...
$SelectQuery = "SELECT * FROM users WHERE deleted_at IS NULL AND role_id=1 ORDER BY id DESC LIMIT $start,$limit;";
...
if(isset($_GET['delID']) && !empty($_GET['delID'])){
    ...
    $DeleteQuery = "UPDATE users SET deleted_at='$DeleteDate' WHERE id=$DeletedID";
...
<html>
    ...
    <body>
        <div class="container">
            <br>
            <a href="AddNewAdmin.php" class="btn btn-success">Add New Admin</a> <br>
            <hr>
            <div id="content">
                <div class="inner">
                    <div class="row">
                                                    ...
                                                    while($fetch = mysqli_fetch_array($result)){
                                                        echo '<tr class="even gradeC">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="EditAdmin.php?EditID='.$fetch['id'].'" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                            </td>
                                                        </tr>';
                                                    }        
                                                ?>
