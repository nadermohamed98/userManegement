    ...
    <nav class="navbar navbar-inverse">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="../Dashboard/home.php"><i class="fa fa-home"></i> Users Manegment</a>
            </div>
            <ul class="nav navbar-nav">
                <li class="dropdown <?php if(in_array(str_replace("UMG/users/","",$_SERVER['PHP_SELF']),["/admins.php","/users.php","/EditAdmin.php"])){echo 'active';}else{echo '';} ?>">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="../users/users.php"><i class="fa fa-users"></i> Users</a></li>
                    </ul>
                </li>
            </ul>
